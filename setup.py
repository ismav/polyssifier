...
DISTNAME = 'polyssifier'
MAINTAINER = 'Sergey Plis'
MAINTAINER_EMAIL = 's.m.plis@gmail.com'
DESCRIPTION = 'A Python module for classification'
LONG_DESCRIPTION = open('README.md').read()
URL = 'http://www.mrn.org'
DOWNLOAD_URL = 'http://github.com/ismav/polyssifier'
KEYWORDS = ['scikit-learn', 'classification', 'machine learning', 'data mining']
LICENSE = ''
VERSION = ''
ISRELEASED = True
...
def setup_package():
    ...
    setup(
        ...
        package_dir={DISTNAME: "./polyssifier"},
